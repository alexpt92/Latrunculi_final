...
%%Das 3. Kapitel erklärt die Implementierung des Spiels, sowie der KI. Anschließend wird beschrieben wie der Launch beim Kunden im Museum unter gegebenen Umständen stattgefunden hat.
